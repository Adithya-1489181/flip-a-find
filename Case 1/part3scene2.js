const dialogues = [
  { speaker: "Watson", text: "Volume!! What kind of a joke is this ? How can a sound be lost ?" },
  { speaker: "Sherlock", text: "It is not the sound its the volumes of a musical book that has been lost. Some important ones. Check out the black market and you will find Ms. Elira!!" }
];
